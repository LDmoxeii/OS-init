...
export FZF_DEFAULT_OPTS="--preview 'bash ~/.oh-my-zsh/custom/config/file_preview.sh {}' --height 12 --layout=reverse --history=/home/moxeii/.history/fzf_history"
...
zstyle ':fzf-tab:complete:*:*' fzf-preview 'bash ~/.oh-my-zsh/custom/config/file_preview.sh ${(Q)realpath}'
